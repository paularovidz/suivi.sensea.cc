    ...
    >
      ...
      >
        <div
          ...
          :key="toast.id"
          :class="[
            'pointer-events-auto w-full rounded-lg border shadow-lg overflow-hidden',
            getClasses(toast.type).container
          ]"
        >
          <div class="p-4">
            <div class="flex items-start">
              ...
              <div class="flex-shrink-0">
                <svg
                  :class="['h-5 w-5', getClasses(toast.type).icon]"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
                  <path
              ...
              <div class="ml-3 flex-1">
                <p
                  v-if="toast.title"
                  :class="['text-sm font-medium', getClasses(toast.type).title]"
                >
                  {{ toast.title }}
                </p>
                <p
              ...
              <div class="ml-4 flex-shrink-0 flex">
                <button
                  ...
                  :class="[
                    'rounded-md inline-flex p-1.5 focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors',
                    getClasses(toast.type).close
                  ]"
                >
